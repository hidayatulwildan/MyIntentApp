package com.dicoding.hildanesia.myintentapp;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                MoveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Hidayatul Wildan Nugraha");
                MoveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 5);
                startActivity(MoveWithDataIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "083819107673";
